...
const PanGesture = ({ width, height }: Props) => {
    ...
    return (
        <View {...panResponder.panHandlers}>
            ...
            >
                <View style={[styles.box, styles.back, { width, height }]}>
